...
router.post('/', isLoggedIn, controller.create); // Ensure user is logged in
...
router.put('/:id', validateId, isLoggedIn, isOwner, controller.update); // Ensure user is logged in and is owner
